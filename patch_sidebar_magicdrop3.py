...
# Let's find where to insert the functions
states = """
    // Magic Drop states
...
content = content.replace("    const [expandedExpId, setExpandedExpId] = useState(null);", "    const [expandedExpId, setExpandedExpId] = useState(null);" + states)
