        ...
        >
            ...
            >
                ...
                <div className="space-y-3 pt-1">
                    ...
                    {/* Option 4: Gestionnaire financier / Décompte */}
                    <button
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="font-bold text-xs text-white group-hover:text-emerald-300 transition-colors">
                                Gestionnaire financier (Ventilation de décompte)
                            </div>
                            <div className="text-[10px] text-slate-400 mt-0.5 leading-tight">
                                Ouvre le gestionnaire financier et ingère la lettre de décompte pour ventiler les montants.
                            </div>
                        </div>
                    </button>
                </div>
